...
pissalotApp.factory('pissalotCouchService', function (basicCouchService) {
...
pissalotApp.factory('basicCouchService', function ($resource, $http, Base64) {

    return $resource('/pissalot/_design/bla/_view/:listType',{
        listType: '@listType'
    }, {
        get: {
            method: 'GET',
            ...
            headers: {'Authorization': 'Basic ' +
                Base64.encode('wheyedistardychationsere' + ':' + 'IicBXaCdwTMdFIscBc8HXSKs')}
        }
    });
});

pissalotApp.factory('Base64', function() {
